...
class TssController extends Controller
{
    ...
    public function store(Request $request)
    {
        $validator = Validator::make($request->all(), [
            ...
            'porcentaje.max' => 'Numero maximo hasta el 100',
        ]);
        ...
        return response()->json(['success' => true, 'message' => 'Beneficio Creado con exito.', 'data' => $Tss]);
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        return response()->json(['success' => true,'message' => 'Beneficio actualizado.', 'data' => $Tss]);
    }
